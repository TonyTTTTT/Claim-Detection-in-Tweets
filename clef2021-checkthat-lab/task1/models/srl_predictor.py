...
if __name__ == '__main__':
    ...
    r = predictor.get_frames('Since this will never get reported by the media , I wanted to share a copy of this '
                             'check . @USER is once again donating his salary back to the United States Government — '
                             'This quarter , it will be donated to @USER to confront , contain , and combat '
                             '#Coronavirus.')
