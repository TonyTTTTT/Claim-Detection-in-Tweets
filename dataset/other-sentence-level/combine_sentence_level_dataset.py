...
cnt_dev = 0
cnt_test = 0
dataset_list = ['ClaimBuster_processed', 'VG_processed', 'NewsClaims_processed', 'OC_processed', 'WD_processed', 'WTP_processed', 'MT_processed', 'PE_processed']
...
combined_dataset_name = 'CB_VG_NC_OC_WD_WTP_MT_PE'
