...
def rewrite_by_GPT(*args):
    ...
    prompt = 'Please correct any grammatical errors in the provided content. Please also remove taggings, hashtags and informal words.'
    rewrite_method = '{}_by_GPT_v3'.format('normalize')
