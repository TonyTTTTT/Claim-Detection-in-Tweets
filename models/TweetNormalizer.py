...
def normalizeTweet(tweets):
    print('del tail hashtag: {}, del @: {}, del #: {}, del url: {}, del emoji: {}, replace covid: {}'.format(delete_tail_hashtag ,delete_at, delete_hashtag, delete_url, delete_emoji, replace_covid))
    if type(tweets) != list:
        tweets = [tweets]
...
if __name__ == "__main__":
    examples = [
        ...
        "This is how you annihilate northern Italy—check the date of the post! The CCP and WHO basically killed the Chinese, and then let it spread to hide their bioweapons work. #CCPVirus #CCPLiedPeopleDied #CCPVirus #CCP_is_terrorist #Coronavirustruth #COVID19 https://t.co/D49H4d7oET",
